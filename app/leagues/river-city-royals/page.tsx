...
export default function RiverCityRoyalsPage() {
  ...
  const [players, setPlayers] = useState([
    ...
    { id: 2, name: "Carlos Martinez", position: "Opening Batsman", battingStyle: "Left-hand", bowlingStyle: "N/A" },
    {
      id: 3,
      name: "Antonio Garcia",
    ...
    { id: 4, name: "Diego Rodriguez", position: "Wicket-keeper", battingStyle: "Right-hand", bowlingStyle: "N/A" },
    {
      id: 5,
      name: "Miguel Santos",
    ...
    { id: 10, name: "Javier Gonzalez", position: "Opening Batsman", battingStyle: "Right-hand", bowlingStyle: "N/A" },
    {
      id: 11,
      name: "Eduardo Silva",
      position: "Middle-order Batsman",
    ...
    { id: 15, name: "Sergio Mendoza", position: "Wicket-keeper", battingStyle: "Left-hand", bowlingStyle: "N/A" },
  ])
  ...
  const handleAddPlayer = (e: React.FormEvent) => {
    ...
    toast({
      title: "Player Added!",
      description: `${newPlayer.name} has been successfully added to River City Royals.`,
    })
  }

  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-orange-50">
      <Header />

      {/* Team Header */}
      <section className="bg-gradient-to-r from-indigo-600 to-orange-500 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="flex items-center justify-center space-x-3 mb-4">
              <img
                src="/placeholder.svg?height=48&width=48"
                alt="River City Royals logo"
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4">River City Royals</h1>
            <p className="text-xl mb-6">Balanced All-rounders • Founded 2021</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <Card className="text-center hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              <CardHeader>
                ...
                <CardTitle className="text-indigo-800">Team Captain</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="font-semibold text-lg">James Wilson</p>
                <p className="text-slate-600">All-rounder • 5 years experience</p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              ...
              <CardContent>
                <p className="font-semibold text-lg">Semi-finalists 2024</p>
                <p className="text-slate-600">Strong playoff performance</p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              ...
              <CardContent>
                <p className="font-semibold text-lg">Strong All-rounders</p>
                <p className="text-slate-600">Balanced team composition</p>
              </CardContent>
            </Card>
          </div>
        </div>
      ...
      {/* Current Squad */}
      <section className="py-16 bg-gradient-to-br from-indigo-50 to-orange-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-800 mb-4">Current Squad</h2>
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
              Meet the talented players representing River City Royals
            </p>
          </div>
              ...
              >
                <CardHeader>
                  <div className="flex items-center justify-between">
                    ...
                    {player.position.includes("Captain") && <Badge className="bg-indigo-600 text-white">Captain</Badge>}
                  </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <Card className="bg-white/80 backdrop-blur-sm shadow-xl">
            <CardHeader className="text-center">
              ...
              <CardDescription className="text-lg">Add a new player to the River City Royals squad</CardDescription>
            </CardHeader>
            <CardContent>
