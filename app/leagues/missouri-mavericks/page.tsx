...
export default function MissouriMavericksPage() {
  ...
  const [players, setPlayers] = useState([
    ...
    { id: 2, name: "Raj Kumar", position: "Opening Batsman", battingStyle: "Right-hand", bowlingStyle: "N/A" },
    { id: 3, name: "Amit Singh", position: "Fast Bowler", battingStyle: "Right-hand", bowlingStyle: "Right-arm fast" },
    {
      id: 4,
      name: "Vikram Sharma",
    ...
    { id: 5, name: "Arjun Gupta", position: "Wicket-keeper", battingStyle: "Right-hand", bowlingStyle: "N/A" },
    { id: 6, name: "Deepak Mehta", position: "Middle-order Batsman", battingStyle: "Left-hand", bowlingStyle: "N/A" },
    {
      id: 7,
      name: "Rohit Joshi",
    ...
    { id: 9, name: "Kiran Nair", position: "Spin Bowler", battingStyle: "Left-hand", bowlingStyle: "Left-arm spin" },
    { id: 10, name: "Manish Agarwal", position: "Opening Batsman", battingStyle: "Right-hand", bowlingStyle: "N/A" },
    {
      id: 11,
      name: "Sanjay Verma",
    ...
    { id: 12, name: "Ravi Iyer", position: "Fast Bowler", battingStyle: "Right-hand", bowlingStyle: "Right-arm fast" },
    {
      id: 13,
      name: "Ashwin Pillai",
  ...
  const handleAddPlayer = (e: React.FormEvent) => {
    ...
    toast({
      title: "Player Added!",
      description: `${newPlayer.name} has been successfully added to Missouri Mavericks.`,
    })
  }
      ...
      <section className="bg-gradient-to-r from-purple-600 to-gray-600 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Missouri Mavericks</h1>
            <p className="text-xl mb-6">Tactical Experts • Founded 2017</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <Card className="text-center hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              <CardHeader>
                ...
                <CardTitle className="text-purple-800">Team Captain</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="font-semibold text-lg">Priya Patel</p>
                <p className="text-slate-600">Spin Bowler • 7 years experience</p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              ...
              <CardContent>
                <p className="font-semibold text-lg">League Champions 2022</p>
                <p className="text-slate-600">Strategic masterclass in playoffs</p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              ...
              <CardContent>
                <p className="font-semibold text-lg">Tactical Expertise</p>
                <p className="text-slate-600">Experienced squad with game plans</p>
              </CardContent>
            </Card>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
              Meet the talented players representing Missouri Mavericks
            </p>
          </div>
              ...
              >
                <CardHeader>
                  <div className="flex items-center justify-between">
                    ...
                    {player.position.includes("Captain") && <Badge className="bg-purple-600 text-white">Captain</Badge>}
                  </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <Card className="bg-white/80 backdrop-blur-sm shadow-xl">
            <CardHeader className="text-center">
              ...
              <CardDescription className="text-lg">Add a new player to the Missouri Mavericks squad</CardDescription>
            </CardHeader>
            <CardContent>
