...
export default function StLouisThunderPage() {
  ...
  const [players, setPlayers] = useState([
    ...
    { id: 2, name: "James Patterson", position: "Wicket-keeper", battingStyle: "Left-hand", bowlingStyle: "N/A" },
    { id: 3, name: "David Kumar", position: "Opening Batsman", battingStyle: "Right-hand", bowlingStyle: "N/A" },
    {
      id: 4,
      name: "Alex Thompson",
    ...
    { id: 5, name: "Ryan Mitchell", position: "Spin Bowler", battingStyle: "Left-hand", bowlingStyle: "Left-arm spin" },
    {
      id: 6,
      name: "Chris Johnson",
    ...
    { id: 9, name: "Tom Anderson", position: "Batsman", battingStyle: "Left-hand", bowlingStyle: "N/A" },
    {
      id: 10,
      name: "Jake Miller",
      position: "All-rounder",
    ...
    { id: 11, name: "Ben Taylor", position: "Wicket-keeper", battingStyle: "Right-hand", bowlingStyle: "N/A" },
    {
      id: 12,
      name: "Sam Brown",
    ...
    { id: 13, name: "Luke Garcia", position: "Opening Batsman", battingStyle: "Left-hand", bowlingStyle: "N/A" },
    {
      id: 14,
      name: "Matt Williams",
      position: "Fast Bowler",
  ...
  const handleAddPlayer = (e: React.FormEvent) => {
    ...
    toast({
      title: "Player Added!",
      description: `${newPlayer.name} has been successfully added to St. Louis Thunder.`,
    })
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-yellow-50">
      ...
      {/* Team Header */}
      <section className="bg-gradient-to-r from-blue-600 to-yellow-500 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="flex items-center justify-center space-x-3 mb-4">
              <img
                src="/placeholder.svg?height=64&width=64"
                alt="St. Louis Thunder logo"
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4">St. Louis Thunder</h1>
            <p className="text-xl mb-6">Defending Champions • Founded 2018</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <Card className="text-center hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              <CardHeader>
                ...
                <CardTitle className="text-blue-800">Team Captain</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="font-semibold text-lg">Michael Rodriguez</p>
                <p className="text-slate-600">All-rounder • 8 years experience</p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              ...
              <CardContent>
                <p className="font-semibold text-lg">League Champions 2024</p>
                <p className="text-slate-600">Defeated Gateway Warriors in final</p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              ...
              <CardContent>
                <p className="font-semibold text-lg">Strong Batting Lineup</p>
                <p className="text-slate-600">Highest team average in league</p>
              </CardContent>
            </Card>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
              Meet the talented players representing St. Louis Thunder
            </p>
          </div>
              ...
              >
                <CardHeader>
                  <div className="flex items-center justify-between">
                    ...
                    {player.position.includes("Captain") && <Badge className="bg-yellow-600 text-white">Captain</Badge>}
                  </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <Card className="bg-white/80 backdrop-blur-sm shadow-xl">
            <CardHeader className="text-center">
              ...
              <CardDescription className="text-lg">Add a new player to the St. Louis Thunder squad</CardDescription>
            </CardHeader>
            <CardContent>
