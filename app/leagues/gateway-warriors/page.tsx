...
export default function GatewayWarriorsPage() {
  const { toast } = useToast()
  const [players, setPlayers] = useState([
    {
      id: 1,
      name: "Sarah Johnson",
      position: "Captain/Fast Bowler",
      battingStyle: "Right-hand",
      bowlingStyle: "Right-arm fast",
    },
    { id: 2, name: "Emma Davis", position: "Wicket-keeper", battingStyle: "Left-hand", bowlingStyle: "N/A" },
    { id: 3, name: "Rachel Smith", position: "Opening Batsman", battingStyle: "Right-hand", bowlingStyle: "N/A" },
    {
      id: 4,
      name: "Kevin O'Connor",
    ...
    { id: 8, name: "Mike Turner", position: "Fast Bowler", battingStyle: "Right-hand", bowlingStyle: "Right-arm fast" },
    { id: 9, name: "Anna Rodriguez", position: "Batsman", battingStyle: "Left-hand", bowlingStyle: "N/A" },
    {
      id: 10,
      name: "Paul Jackson",
      position: "All-rounder",
    ...
    { id: 11, name: "Sophie Chen", position: "Opening Batsman", battingStyle: "Right-hand", bowlingStyle: "N/A" },
    {
      id: 12,
      name: "Daniel Kim",
      position: "Spin Bowler",
    ...
    { id: 13, name: "Jessica Lee", position: "Middle-order Batsman", battingStyle: "Left-hand", bowlingStyle: "N/A" },
    {
      id: 14,
      name: "Robert Wilson",
      position: "Fast Bowler",
  ...
  const handleAddPlayer = (e: React.FormEvent) => {
    ...
    toast({
      title: "Player Added!",
      description: `${newPlayer.name} has been successfully added to Gateway Warriors.`,
    })
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 to-gray-50">
      ...
      {/* Team Header */}
      <section className="bg-gradient-to-r from-red-600 to-gray-700 text-white py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <Card className="text-center hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              <CardHeader>
                ...
                <CardTitle className="text-red-800">Team Captain</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="font-semibold text-lg">Sarah Johnson</p>
                <p className="text-slate-600">Fast Bowler • 6 years experience</p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              ...
              <CardContent>
                <p className="font-semibold text-lg">League Runners-up 2024</p>
                <p className="text-slate-600">Lost to St. Louis Thunder in final</p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              ...
              <CardContent>
                <p className="font-semibold text-lg">Aggressive Fast Bowling</p>
                <p className="text-slate-600">Best bowling attack in league</p>
              </CardContent>
            </Card>
          </div>
        </div>
      ...
      {/* Current Squad */}
      <section className="py-16 bg-gradient-to-br from-red-50 to-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-800 mb-4">Current Squad</h2>
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
              Meet the talented players representing Gateway Warriors
            </p>
          </div>
              ...
              >
                <CardHeader>
                  <div className="flex items-center justify-between">
                    ...
                    {player.position.includes("Captain") && <Badge className="bg-red-600 text-white">Captain</Badge>}
                  </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <Card className="bg-white/80 backdrop-blur-sm shadow-xl">
            <CardHeader className="text-center">
              ...
              <CardDescription className="text-lg">Add a new player to the Gateway Warriors squad</CardDescription>
            </CardHeader>
            <CardContent>
